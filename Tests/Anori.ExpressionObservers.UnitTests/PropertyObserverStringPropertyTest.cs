// -----------------------------------------------------------------------
// <copyright file="PropertyObserverStringPropertyTest.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.UnitTests
{
    ...
    public class PropertyObserverStringPropertyTest
    {
        ...
        [Test]
        public void
            PropertyObserver_OnValueChanged_Observes_instance_StringProperty_TaskSchedulerCurrent_AutoActivateFalse()
        {
            var instance = new NotifyPropertyChangedClass1();
            var callCount = 0;
            using var observes = PropertyReferenceObserver.ObservesOnValueChanged(
        ...
        [Test]
        public void
            PropertyObserver_OnValueChanged_Observes_instance_StringProperty_TaskSchedulerCurrent_AutoActivateTrue()
        {
            var instance = new NotifyPropertyChangedClass1();
            var callCount = 0;
            using var observes = PropertyReferenceObserver.ObservesOnValueChanged(
    ...
    public class PropertyObserverBuilderCountTests
    {
        ...
        public void PropertyValueObserver_Count_OnValue_ABC_Fallback()
        {
            ...
            using var ab = PropertyObserverBuilder.Builder.ValueObserverBuilder(() => a.Value + b.Value)
                .OnValueChanged()
                .WithAction(() => callCountAB++)
                .WithFallback(0)
                .Build()
            ...
            using var observes = PropertyObserverBuilder.Builder.ValueObserverBuilder(() => ab.Value + c.Value)
                .OnValueChanged()
                .WithAction(() => callCountABC++)
                .Build()
                .Activate();
        ...
        public void PropertyValueObserver_Count_OnValue_ABC_Null()
        {
            ...
            using var a = PropertyObserverBuilder.Builder.ValueObserverBuilder(() => instance1.Class2.IntProperty)
                .OnValueChanged()
                .WithAction(() => callCountA++)
                .Build()
                .Activate();
            ...
            using var c = PropertyObserverBuilder.Builder
                .ValueObserverBuilder(
                    () => instance31.Class2.IntProperty + instance32.Class2.IntProperty + instance33.Class2.IntProperty)
                .OnValueChanged()
                .WithAction(() => callCountC++)
                .Build()
                .Activate();
