...
namespace Anori.ExpressionObservers
{
    ...
    public static partial class PropertyReferenceObserver
    {
        ...
        public static IGetterReferencePropertyObserver<TResult> Observes<TParameter1, TParameter2, TResult>(
            ...
            where TResult : class =>
            new ReferenceObservers.OnPropertyChanged.Observer<TParameter1, TParameter2, TResult>(
                parameter1,
                parameter2,
                propertyExpression,
                action,
        ...
        public static INotifyReferencePropertyObserver<TResult>
            ...
            where TParameter2 : INotifyPropertyChanged
            where TResult : class =>
            new ReferenceObservers.OnValueChanged.Observer<TParameter1, TParameter2, TResult>(
                parameter1,
                parameter2,
                propertyExpression,
                PropertyObserverFlag.None);
        ...
        public static INotifyReferencePropertyObserver<TResult>
            ...
            where TResult : class
        {
            var observer = new ReferenceObservers.OnValueChanged.Observer<TParameter1, TParameter2, TResult>(
                parameter1,
                parameter2,
                propertyExpression,
                PropertyObserverFlag.None);
