...
namespace Anori.ExpressionObservers.Base
{
        ...
        where TSelf : IPropertyObserverBase<TSelf>
    {
        ...
        /// </value>
        [NotNull]
        private protected Action UpdateValueAction { get; set; }
        ...
        /// </value>
        [NotNull]
        private protected Action SilentUpdateValueAction { get; set; }
        ...
        /// </summary>
        protected override void OnSilentActivate() => this.SilentUpdateValueAction.Raise();

        /// <summary>
        ///     On the UpdateValueAction.
        /// </summary>
        protected override void OnAction() => this.UpdateValueAction();
