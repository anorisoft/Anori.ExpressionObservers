...
namespace Anori.ExpressionObservers.ValueObservers.OnValueChanged
{
    ...
    internal sealed class ValueObserverOnNotifyProperyChanged<TResult> :
        ...
        where TResult : struct
    {
        ...
        internal ValueObserverOnNotifyProperyChanged(
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="CachedObserver{TResult}" />
        ///     class.
        /// </summary>
        /// <param name="propertyExpression">The property expression.</param>
        /// <param name="taskScheduler">The task scheduler.</param>
        ...
        {
            var get = ExpressionGetter.CreateValueGetterByTree<TResult>(propertyExpression.Parameters, tree);
            return () => get();
        }
