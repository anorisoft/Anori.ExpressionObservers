...
namespace Anori.ExpressionObservers
{
    ...
    public static partial class PropertyObserver
    {
        ...
        /// </returns>
        public static PropertyObserverWithAndFallback<TParameter1, TResult> Observes<TParameter1, TResult>(
            [NotNull] this TParameter1 parameter1,
            [NotNull] Expression<Func<TParameter1, TResult>> propertyExpression,
            [NotNull] Action action,
            [NotNull] TResult fallback)
            where TParameter1 : INotifyPropertyChanged =>
            new PropertyObserverWithAndFallback<TParameter1, TResult>(
                parameter1,
                propertyExpression,
                action,
                fallback);
        ...
        public static PropertyObserverWithFallback<TParameter1, TResult> Observes<TParameter1, TResult>(
            ...
            [NotNull] TResult fallback)
            where TParameter1 : INotifyPropertyChanged =>
            new PropertyObserverWithFallback<TParameter1, TResult>(
                parameter1,
                propertyExpression,
                action,
                fallback);
