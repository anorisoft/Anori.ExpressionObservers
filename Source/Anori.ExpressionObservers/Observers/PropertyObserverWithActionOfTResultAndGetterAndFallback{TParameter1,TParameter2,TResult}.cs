// -----------------------------------------------------------------------
// <copyright file="PropertyObserverWithActionOfTResultAndGetterAndFallback{TParameter1,TParameter2,TResult}.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.Observers
{
    ...
    /// <seealso
    ///     cref="PropertyObserverWithActionAndGetterAndFallback{TResult}" />
    /// <seealso cref="PropertyObserverFundatinBase" />
    internal sealed class PropertyObserverWithActionOfTResultAndGetterAndFallback<TParameter1, TParameter2, TResult> :
        ...
        where TParameter2 : INotifyPropertyChanged
    {
        ...
        ///     <see cref="PropertyObserverWithActionOfTResultAndGetterAndFallback{TParameter1,TParameter2,TResult}" />
        ///     class.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the
        ///     <see cref="PropertyObserverWithActionOfTResultAndGetterAndFallback{TParameter1,TParameter2,TResult}" /> class.
        /// </summary>
        /// <param name="parameter1">The parameter1.</param>
        /// <param name="parameter2">The parameter2.</param>
        /// <param name="propertyExpression">The property expression.</param>
