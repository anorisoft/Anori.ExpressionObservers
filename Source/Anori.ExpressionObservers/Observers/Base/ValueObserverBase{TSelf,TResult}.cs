// -----------------------------------------------------------------------
// <copyright file="ValueObserverBase{TSelf,TResult}.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.Observers.Base
{
    ...
    internal abstract class ValueObserverBase<TSelf, TResult> : ObserverBase<TSelf, TResult>
        ...
        where TResult : struct
    {
        ...
        protected ValueObserverBase(
            [NotNull] [ItemNotNull] Expression<Func<TResult>> propertyExpression,
