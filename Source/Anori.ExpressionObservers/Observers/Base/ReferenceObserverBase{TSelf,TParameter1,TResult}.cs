// -----------------------------------------------------------------------
// <copyright file="ReferenceObserverBase{TSelf,TParameter1,TResult}.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.Observers.Base
{
    ...
    /// <summary>
    ///     The reference observer base class.
    /// </summary>
    ...
    internal abstract class
        ReferenceObserverBase<TSelf, TParameter1, TResult> : ObserverBase<TSelf, TParameter1, TResult>
        where TParameter1 : INotifyPropertyChanged
        where TSelf : IPropertyObserverBase<TSelf>
        where TResult : class
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ReferenceObserverBase{TSelf, TParameter1, TResult}" /> class.
        /// </summary>
        /// <param name="parameter1">The parameter1.</param>
        /// <param name="propertyExpression">The property expression.</param>
        /// <param name="observerFlag">The observer flag.</param>
        protected ReferenceObserverBase(
