// -----------------------------------------------------------------------
// <copyright file="ValueObserverOnValueChangedBase{TSelf,TParameter1,TResult}.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.Observers.Base
{
    ...
    internal abstract class
        ValueObserverOnValueChangedBase<TSelf, TParameter1, TResult> :
            ObserverOnValueChangedBase<TSelf, TParameter1, TResult>
        where TParameter1 : INotifyPropertyChanged
        where TSelf : IPropertyObserverBase<TSelf>
        where TResult : struct
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueObserverOnValueChangedBase{TSelf, TParameter1, TResult}"/> class.
        /// </summary>
        ...
        protected ValueObserverOnValueChangedBase(
            [NotNull] TParameter1 parameter1,
            [NotNull] Expression<Func<TParameter1, TResult>> propertyExpression,
            PropertyObserverFlag observerFlag, TResult fallback)
            : base(parameter1, propertyExpression, observerFlag)
        {
