// -----------------------------------------------------------------------
// <copyright file="ObserverWithActionOfTAndGetterAndFallbackAndDeferrer{TParameter1,TParameter2,TResult}.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.Observers.OnPropertyChanged
{
    ...
    internal sealed class ObserverWithActionOfTAndGetterAndFallbackAndDeferrer<TParameter1, TParameter2, TResult> :
        ...
        where TParameter2 : INotifyPropertyChanged
    {
        ...
        ///     <see cref="ObserverWithActionOfTAndGetterAndFallbackAndDeferrer{TParameter1,TParameter2,TResult}" />
        ///     class.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the
        ///     <see cref="ObserverWithActionOfTAndGetterAndFallbackAndDeferrer{TParameter1,TParameter2,TResult}" /> class.
        /// </summary>
        /// <param name="parameter1">The parameter1.</param>
        /// <param name="parameter2">The parameter2.</param>
        /// <param name="propertyExpression">The property expression.</param>
