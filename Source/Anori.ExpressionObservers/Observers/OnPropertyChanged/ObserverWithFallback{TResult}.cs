...
namespace Anori.ExpressionObservers.Observers.OnPropertyChanged
{
    ...
    internal sealed class GetterObserverWithFallback<TResult> :
        ...
        IGetterPropertyObserver<TResult>
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ObserverWithFallback{TParameter1,TParameter2,TResult}" /> class.
        /// </summary>
        /// <param name="propertyExpression">The property expression.</param>
        /// <param name="taskScheduler">The task scheduler.</param>
        /// <param name="fallback">The fallback.</param>
        /// <param name="propertyObserverFlag">The property observer flag.</param>
        internal GetterObserverWithFallback(
