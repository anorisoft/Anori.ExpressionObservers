// -----------------------------------------------------------------------
// <copyright file="PropertyObserverWithActionOfTResultAndGetterAndFallback{TParameter1,TResult}.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.Observers
{
    ...
    internal sealed class PropertyObserverWithActionOfTResultAndGetterAndFallback<TParameter1, TResult> :
        ...
        where TParameter1 : INotifyPropertyChanged
    {
        ...
        ///     <see cref="PropertyObserverWithActionOfTResultAndGetterAndFallback{TParameter1,TResult}" />
        ///     class.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the
        ///     <see cref="PropertyObserverWithActionOfTResultAndGetterAndFallback{TParameter1,TResult}" /> class.
        /// </summary>
        /// <param name="parameter1">The parameter1.</param>
        /// <param name="propertyExpression">The property expression.</param>
        /// <param name="action">The action.</param>
