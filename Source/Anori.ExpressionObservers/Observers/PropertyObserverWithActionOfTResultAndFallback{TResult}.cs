// -----------------------------------------------------------------------
// <copyright file="PropertyObserverWithActionOfTResultAndFallback{TResult}.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.Observers
{
    ...
    internal sealed class PropertyObserverWithActionOfTResultAndFallback<TResult> :
        ...
        IPropertyObserverWithFallback<TResult>
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="PropertyObserverWithActionOfTResultAndFallback{TResult}" /> class.
        /// </summary>
