...
namespace Anori.ExpressionObservers.Builder
{
    ...
    /// <seealso
    ///     cref="PropertyObserverBuilderBase{TSelf}.ExpressionObservers.Builder.PropertyValueObserverBuilder{TParameter1, TParameter2, TResult}, TResult}" />
        ...
        where TResult : struct
    {
        ...
        protected override IPropertyObserverWithGetterAndFallback<TResult> CreatePropertyObserverWithActionOfTResultAndGetterAndFallback()
        {
            ...
            if (this.IsDispached)
            {
                observer = new PropertyObserverWithActionOfTResultAndGetterAndFallback<TParameter1, TParameter2, TResult>(
                    this.parameter1,
                    this.parameter2,
                    this.propertyExpression,
                    this.ActionOfTResultWithFallback!,
            ...
            CreatePropertyValueObserverBuilderWithValueChangedAndDeferrer()
        {
            ...
            if (this.IsDispached)
            {
                observer = new PropertyValueObserverOnValueChangedWithDefer<TParameter1, TParameter2, TResult>(
                    this.parameter1,
                    this.parameter2,
                    this.propertyExpression,
                    SynchronizationContext.Current,
