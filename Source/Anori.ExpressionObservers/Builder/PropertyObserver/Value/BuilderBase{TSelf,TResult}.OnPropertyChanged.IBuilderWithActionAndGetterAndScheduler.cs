// -----------------------------------------------------------------------
// <copyright file="BuilderBase{TSelf,TResult}.OnPropertyChanged.IBuilderWithActionAndGetterAndScheduler.cs" company="AnoriSoft">
...
namespace Anori.ExpressionObservers.Builder.PropertyObserver.Value
{
    ...
    internal abstract partial class BuilderBase<TSelf, TResult> : IBuilderWithActionAndGetterAndScheduler<TResult>
    {
        ...
        IBuilderWithActionAndGetterAndScheduler<TResult>
            IObserverBuilderBase<IBuilderWithActionAndGetterAndScheduler<TResult>>.AutoActivate() =>
            this.AutoActivate();
        ...
        /// </returns>
        IBuilderWithActionAndGetterAndFallbackAndScheduler<TResult> IBuilderWithActionAndGetterAndScheduler<TResult>.
