...
namespace Anori.ExpressionObservers.Builder.PropertyObserver.Value
{
    ...
    internal sealed class Builder<TParameter1, TResult> : PropertyObserver.Value.BuilderBase<
        ...
        where TResult : struct
    {
        ...
        {
            var observer = new ValueObservers.OnPropertyChanged.Observer<TParameter1, TResult>(
                this.parameter1,
                this.propertyExpression,
                this.Action!,
                this.ObserverFlag);
        ...
        protected override IGetterValuePropertyObserver<TResult> CreatePropertyValueObserver()
        {
            ...
            if (this.IsDispached)
            {
                observer = new ValueObservers.OnPropertyChanged.Observer<TParameter1, TResult>(
                    this.parameter1,
                    this.propertyExpression,
                    this.ActionOfT!,
                    SynchronizationContext.Current,
            ...
            CreatePropertyValueObserverBuilderOnValueChanged()
        {
            ...
            if (this.IsDispached)
            {
                observer = new ValueTypeObservers.Observer<TParameter1, TResult>(
                    this.parameter1,
                    this.propertyExpression,
                    SynchronizationContext.Current,
                    this.ObserverFlag);
            ...
            CreatePropertyValueObserverOnNotifyProperyChanged()
        {
            ...
            if (this.IsDispached)
            {
                observer = new ValueObserverOnNotifyProperyChanged<TParameter1, TResult>(
                    this.parameter1,
                    this.propertyExpression,
                    SynchronizationContext.Current,
                    this.IsCached,
        ...
        protected override IGetterValuePropertyObserver<TResult> CreateNotifyValuePropertyObserverWithGetter()
        {
            ...
            if (this.IsDispached)
            {
                observer = new ObserverWithGetter<TParameter1, TResult>(
                    this.parameter1,
                    this.propertyExpression,
                    this.Action!,
                    SynchronizationContext.Current,
