...
namespace Anori.ExpressionObservers.Interfaces
{
    ...
    public interface IExpressionGetterBuilder
    {
        ...
        /// <param name="expression">The expression.</param>
        /// <returns>The Reference Getter Builder.</returns>
        IReferenceGetterBuilder<TResult> ReferenceGetter<TResult>(
        ...
        IValueGetterBuilder<TParameter1, TParameter2, TParameter3, TResult> ValueGetter<TParameter1, TParameter2, TParameter3, TResult>(
        ...
        /// The Value Getter Builder.
        /// </returns>
        IValueGetterBuilder<TResult> ValueGetter<TResult>(
            Expression<Func<TResult>> expression)
            where TResult : struct;
    }
}