...
namespace Anori.ExpressionTrees.Nodes
{
    ...
    internal readonly struct MemberListBindingNode : IMemberListBindingNode
    {
        /// <summary>
        ...
        public MemberListBindingNode(MemberListBinding memberListBinding, List<IElementInitNode> initializers)
        {
        ...
        ///     The initializers.
        /// </value>
        public List<IElementInitNode> Initializers { get; }
